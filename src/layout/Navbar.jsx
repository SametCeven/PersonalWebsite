...
export default function Navbar(){
    ...
    return(
        <nav className={`sticky z-99 top-0 ${darkMode?"bg-titleBold":"bg-white"} flex justify-between items-center px-30 py-15 max-md:px-10 max-md:pb-10 max-sm:px-2  ${scrollPosition>200 ? " pb-5" : "" } transition delay-150`}>
