...
export default function Footer(){
    ...
    return(
        <div className={`my-15 flex flex-col justify-center gap-15 h-100 px-30 py-15 ${darkMode ? "bg-title": "bg-[#F9F9F9]"}`}>
            <h1 className="title-1 w-150"> {data[lang].footerSection.title} </h1>
            <div className="flex justify-between">
                <div className="flex">
                    <img className="mr-2" src="../../public/images/pointer.png" alt="" />
                    <span className="text-[#AF0C48] hover:cursor-pointer "> {data[lang].footerSection.email} </span>
                </div>
